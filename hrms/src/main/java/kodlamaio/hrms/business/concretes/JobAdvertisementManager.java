...
public class JobAdvertisementManager implements JobAdvertisementService{
	...
	public DataResult<List<JobAdvertisementDto>> findByIsActive() {
		...
		return new SuccessDataResult<List<JobAdvertisementDto>>(this.jobAdvertisementDao.findByIsActive(),"Active job advertisements listed");
	}

	@Override
	public DataResult<List<JobAdvertisementDto>> findByIsActiveAndApplicationDeadline() {
		
		return new SuccessDataResult<List<JobAdvertisementDto>>(this.jobAdvertisementDao.findByIsActiveOrderByApplicationDeadline(),"All active job advertisements listed by date.");
	}

	@Override
	public DataResult<List<JobAdvertisementDto>> findByIsActiveAndCompanyName(String companyName) {
		
		return new SuccessDataResult<List<JobAdvertisementDto>>(this.jobAdvertisementDao.findByIsActiveAndEmployer_CompanyName(companyName),"All active job advertisements belonging to the company listed");
	}
