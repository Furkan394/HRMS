...
@RestController
@RequestMapping("/api/programming-technologies")
public class ProgrammingTechnologiesController {
	...
	@PostMapping("/add")
	public Result add(@RequestBody ProgrammingTechnology programmingTechnology) {
		return this.programmingTechnologyService.add(programmingTechnology);
	}
}
